...
**Status notice — 2026-09-17:** The two-layer sampling guidance below is the historical August proposal, not the current working frame. On 2026-09-10, Kaveh adopted **Domain ∧ Technology ∧ Labor/Competency** for the three-pillar review. Queries and individual terms are **not frozen**. Terms and tables remain preserved for review; sentiment coding vocabulary is not retrieval vocabulary. See [current working method and history](../README.md).
...
Use with the [search-scope and storage note](keywords-search-storage.md). Search **architecture context AND generative-AI cue** first. Add a skill category only as a second filter. Do not search sentiment words (_excited_, _hype_, _threat_).
...
| architect of record         |                             |                                                     |
| architectural               |                             | Safer than bare _architecture_                      |
...
| artificial intelligence            | AI                 | _AI_ alone is too short  |
| gen AI                             | gen-AI             |                          |
| GenAI                              |                    |                          |
...
Inclusion means people may name the tool instead of saying _generative AI_.

| Term               | Variants                 | Notes                                                          |
| ------------------ | ------------------------ | -------------------------------------------------------------- |
| Adobe Firefly      | Firefly                  |                                                                |
| Autodesk Forma     | Forma                    | _Forma_ alone is weak                                          |
...
Do not infer a role from a name or photo. Prefer self-identification in the text or a consented profile field. Overlap and _unknown_ are allowed.
