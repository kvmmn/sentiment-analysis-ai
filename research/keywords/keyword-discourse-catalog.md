...
**Status notice — 2026-09-17:** The two-layer sampling rules below preserve the historical August proposal. On 2026-09-10, Kaveh adopted **Domain ∧ Technology ∧ Labor/Competency** as the three-pillar working frame for review. Queries and individual terms are **not frozen**; the catalog terms are preserved, not a current collection protocol. See [current working method and history](../README.md).
...
Re-verified 2026-08-31. **Sourced professional/journal use** — do **not** claim Farhangestan or Academy _approval_:

- Honar-ha-ye Ziba (_Me'mari va Shahrsazi_): generative-AI policy page — heading and body use `هوش مصنوعی مولد` — https://jfaup.ut.ac.ir/p_generative-ai
...
Later conservative pass marked **GAP** because it required Academy/INSO/Nezam _lemma_ registration and missed journal/CPD _use_. **Host:** keep as sourced; conservative GAP rejected for this lemma.
