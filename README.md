...
Current focus (2026-08-28): prepare the LinkedIn developer application and its [privacy policy](PRIVACY.md), informed by the [data-access review](research/linkedin-data-access-review.md) and [privacy-policy review](research/privacy-policy-review.md). Access and collection are not yet approved. Kaveh performs LinkedIn setup manually, with guidance in the conversation.
